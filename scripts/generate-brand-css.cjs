...
const updateBrandColorsInThemes = () => {
    ...
    const brandColorLines = [
        ...
        `    --brand-navy: ${colors.navy ?? colors.primary};`,
        `    --brand-accent: ${colors.accent ?? colors.tertiary};`,
        `    --brand-light-tint: ${colors.light_tint ?? colors.white};`,
        `    --brand-page-background: ${colors.page_background ?? colors.white};`,
        `    --brand-border: ${colors.border ?? colors.neutral};`,
        `    --brand-text: ${colors.text ?? colors.black};`,
        `    --brand-text-secondary: ${colors.text_secondary ?? colors.secondary};`,
